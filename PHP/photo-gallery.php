<?php
/**
 * Template Name:  Faces of Humanity
...
<main class="gallery-main">
        ...
        <section class="gallery">
            ...
            <div class="container">
                ...
                <div class="faces-of-humanity">

                    <div class="faces-of-humanity__sidebar">
                      ...
                      <div class="faces-of-humanity__tabs">
                        <button class="faces-of-humanity__tab faces-of-humanity__tab--active" data-photographer="1">PHOTOGRAPHERS NAME</button>
                        <button class="faces-of-humanity__tab" data-photographer="2">PHOTOGRAPHERS NAME</button>
                        <button class="faces-of-humanity__tab" data-photographer="3">PHOTOGRAPHERS NAME</button>
                        <button class="faces-of-humanity__tab" data-photographer="4">PHOTOGRAPHERS NAME</button>
                        <button class="faces-of-humanity__tab" data-photographer="5">PHOTOGRAPHERS NAME</button>
                        <button class="faces-of-humanity__tab" data-photographer="6">PHOTOGRAPHERS NAME</button>
                        <button class="faces-of-humanity__tab" data-photographer="7">PHOTOGRAPHERS NAME</button>
                        <button class="faces-of-humanity__tab" data-photographer="8">PHOTOGRAPHERS NAME</button>
                      </div>

                      <div class="faces-of-humanity__dropdown">
                        <button class="faces-of-humanity__dropdown-button">PHOTOGRAPHERS NAME 
                          <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M8.50003 11.6875C8.36417 11.6875 8.22817 11.6356 8.12444 11.5319L2.81194 6.21938C2.60435 6.01179 2.60435 5.67564 2.81194 5.46819C3.01953 5.26074 3.35567 5.2606 3.56313 5.46819L8.50003 10.4051L13.4369 5.46819C13.6445 5.2606 13.9807 5.2606 14.1881 5.46819C14.3956 5.67578 14.3957 6.01192 14.1881 6.21938L8.87563 11.5319C8.7719 11.6356 8.6359 11.6875 8.50003 11.6875Z" fill="#0B0B0B" />
                          </svg>
                        </button>
                        <div class="faces-of-humanity__dropdown-content">
                            <button class="faces-of-humanity__tab faces-of-humanity__tab--active" data-photographer="1">PHOTOGRAPHERS NAME</button>
                            <button class="faces-of-humanity__tab" data-photographer="2">PHOTOGRAPHERS NAME</button>
                            <button class="faces-of-humanity__tab" data-photographer="3">PHOTOGRAPHERS NAME</button>
                            <button class="faces-of-humanity__tab" data-photographer="4">PHOTOGRAPHERS NAME</button>
                    ...
                    <div class="faces-of-humanity__gallery">
                      <div class="faces-of-humanity__grid faces-of-humanity__grid--active" data-photographer="1">
                        <img src="<?php echo get_template_directory_uri(); ?>/img/gallery/photo-1.jpg" alt="Face 1" class="faces-of-humanity__image photo-1" />
                        <img src="<?php echo get_template_directory_uri(); ?>/img/gallery/photo-2.jpg" alt="Face 2" class="faces-of-humanity__image photo-2" />
                        <img src="<?php echo get_template_directory_uri(); ?>/img/gallery/photo-3.jpg" alt="Face 3" class="faces-of-humanity__image photo-3" />
                        <img src="<?php echo get_template_directory_uri(); ?>/img/gallery/photo-4.jpg" alt="Face 4" class="faces-of-humanity__image photo-4" />
                        <img src="<?php echo get_template_directory_uri(); ?>/img/gallery/photo-5.jpg" alt="Face 5" class="faces-of-humanity__image photo-5" />
                        <img src="<?php echo get_template_directory_uri(); ?>/img/gallery/photo-6.jpg" alt="Face 1" class="faces-of-humanity__image photo-6" />
                        <img src="<?php echo get_template_directory_uri(); ?>/img/gallery/photo-7.jpg" alt="Face 2" class="faces-of-humanity__image photo-7" />
                        <img src="<?php echo get_template_directory_uri(); ?>/img/gallery/photo-8.jpg" alt="Face 3" class="faces-of-humanity__image photo-8" />
                        <img src="<?php echo get_template_directory_uri(); ?>/img/gallery/photo-9.jpg" alt="Face 4" class="faces-of-humanity__image photo-9" />
                        <img src="<?php echo get_template_directory_uri(); ?>/img/gallery/photo-10.jpg" alt="Face 5" class="faces-of-humanity__image photo-10" />
                        
                        
                      </div>
                      
                      <div class="faces-of-humanity__grid" data-photographer="2">
                        <img src="<?php echo get_template_directory_uri(); ?>/img/gallery/photo-10.jpg" alt="Face 1" class="faces-of-humanity__image photo-1" />
                        <img src="<?php echo get_template_directory_uri(); ?>/img/gallery/photo-9.jpg" alt="Face 2" class="faces-of-humanity__image photo-2" />
                        <img src="<?php echo get_template_directory_uri(); ?>/img/gallery/photo-3.jpg" alt="Face 3" class="faces-of-humanity__image photo-3" />
                        <img src="<?php echo get_template_directory_uri(); ?>/img/gallery/photo-4.jpg" alt="Face 4" class="faces-of-humanity__image photo-4" />
                        <img src="<?php echo get_template_directory_uri(); ?>/img/gallery/photo-5.jpg" alt="Face 5" class="faces-of-humanity__image photo-5" />
                        <img src="<?php echo get_template_directory_uri(); ?>/img/gallery/photo-6.jpg" alt="Face 1" class="faces-of-humanity__image photo-6" />
                        <img src="<?php echo get_template_directory_uri(); ?>/img/gallery/photo-7.jpg" alt="Face 2" class="faces-of-humanity__image photo-7" />
                        <img src="<?php echo get_template_directory_uri(); ?>/img/gallery/photo-8.jpg" alt="Face 3" class="faces-of-humanity__image photo-8" />
                        <img src="<?php echo get_template_directory_uri(); ?>/img/gallery/photo-2.jpg" alt="Face 4" class="faces-of-humanity__image photo-9" />
                        <img src="<?php echo get_template_directory_uri(); ?>/img/gallery/photo-1.jpg" alt="Face 5" class="faces-of-humanity__image photo-10" />
                            ...
                            <a href="">
                                <svg width="29" height="28" viewBox="0 0 29 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0_192_38)">
                                      ...
                                      <path d="M16.2654 12.733L22.2587 5.76634H20.8385L15.6345 11.8154L11.4782 5.76634H6.68433L12.9695 14.9136L6.68433 22.2192H8.10461L13.6001 15.8312L17.9895 22.2192H22.7834L16.2651 12.733H16.2654ZM8.61635 6.83552H10.7978L20.8391 21.1986H18.6576L8.61635 6.83552Z" fill="white" />
                                    </g>
                                    <defs>
                            ...
                            <p>
                                <svg width="39" height="39" viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0_192_47)">
                                      <path d="M33.2888 33.2886C40.9041 25.6734 40.9041 13.3266 33.2888 5.71142C25.6736 -1.90381 13.3269 -1.90381 5.71168 5.71142C-1.90355 13.3266 -1.90355 25.6734 5.71168 33.2886C13.3269 40.9038 25.6736 40.9038 33.2888 33.2886Z" fill="#0046A2" />
                                      <path d="M38.1022 21.4548C37.209 30.2608 30.2624 37.2074 21.4565 38.1006C10.7852 39.1836 1.70586 31.2861 0.862793 21.0538L19.4909 20.9566C19.4909 20.9566 19.5 20.952 19.5 20.9475V0.807958C19.5 0.807958 19.5045 0.798843 19.5091 0.798843C30.4781 0.80492 39.2385 10.2534 38.1007 21.4564L38.1022 21.4548Z" fill="white" />
