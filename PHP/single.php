        ...
        <div class="container">
            <div class="article-hero__wrapper">
                ...
                <div class="article-hero__img">
                    <img src="<?php echo get_template_directory_uri(); ?>/img/Rectangle 269.jpg" alt="" />
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="article">
        <div class="container">
            <div class="article__wrapper article__text">
                <p>
                    This is where we dive beneath the surface, unravel the complexities of being human, and foster authentic dialogue about the ugly, and everything in between. It’s a platform to explore the depths of the human experience,
                    together.
                </p>
                ...
                <div class="article-banner">
                    <img src="<?php echo get_template_directory_uri(); ?>/img/Rectangle 270.jpg" alt="" />
                    ...
                    <img src="<?php echo get_template_directory_uri(); ?>/img/Rectangle 272.jpg" alt="" />
                </div>
        ...
        <div class="container">
            <div class="article-author__wrapper">
                <div class="article-author__info">
                    <div class="article-author__text">
                        <p>
                            ...
                            laboriosam, nisi ut aliquid ex ea commodi consequatur? Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur, vel illum qui dolorem eum fugiat quo voluptas nulla
                            pariatur?
                        </p>
                        ...
                        <div class="article-author__author">
                            <div class="article-author__avatar">
                                <img src="<?php echo get_template_directory_uri(); ?>/img/Ellipse 3 (1).jpg" alt="" />
                            </div>
                ...
                <div class="article-author__img">
                    <img src="<?php echo get_template_directory_uri(); ?>/img/Rectangle 273.jpg" alt="" />
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <section class="product-list">
                <div class="product-list__wrapper">
                    <a href="#" class="product-list__card">
                        <img src="<?php echo get_template_directory_uri(); ?>/img/Rectangle 245.jpg" alt="" />
